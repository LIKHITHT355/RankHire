...
export const Route = createFileRoute("/company/dashboard")({
  head: () => ({
    meta: [
      { title: "Recruiter overview — Rank Hire" },
      { name: "description", content: "Your active roles, applications received and shortlist progress." },
      { property: "og:title", content: "Recruiter overview — Rank Hire" },
      { property: "og:description", content: "Your hiring activity on the college record." },
    ],
  }),
