...
export const Route = createFileRoute("/student/jobs")({
  head: () => ({
    meta: [
      { title: "Opportunities — Rank Hire" },
      { name: "description", content: "Open roles, eligibility criteria and deadlines for students." },
      { property: "og:title", content: "Opportunities — Rank Hire" },
      { property: "og:description", content: "Every open role with its eligibility stated up front." },
    ],
  }),
