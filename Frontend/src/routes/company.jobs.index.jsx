...
export const Route = createFileRoute("/company/jobs/")({
  head: () => ({
    meta: [
      { title: "My postings — Rank Hire" },
      { name: "description", content: "Every role your organisation has posted and its applicant count." },
      { property: "og:title", content: "My postings — Rank Hire" },
      { property: "og:description", content: "Your roles on the college placement record." },
    ],
  }),
