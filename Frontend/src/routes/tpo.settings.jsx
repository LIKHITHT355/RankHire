...
export const Route = createFileRoute("/tpo/settings")({
  head: () => ({
    meta: [
      { title: "Placement settings — Rank Hire" },
      { name: "description", content: "Cycle settings for the training and placement cell." },
      { property: "og:title", content: "Placement settings — Rank Hire" },
      { property: "og:description", content: "Eligibility rules and cycle settings." },
    ],
  }),
  component: TpoSettings,
});
