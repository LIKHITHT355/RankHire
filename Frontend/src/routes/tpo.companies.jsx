...
export const Route = createFileRoute("/tpo/companies")({
  head: () => ({
    meta: [
      { title: "Companies — Rank Hire" },
      { name: "description", content: "Recruiters registered with the training and placement cell." },
      { property: "og:title", content: "Companies — Rank Hire" },
      { property: "og:description", content: "Recruiters visiting this placement cycle." },
    ],
  }),
  component: TpoCompanies,
});
